                ...
                <div className="updateRight">
                    ...
                    <form className="updateBox" onSubmit={submitHandler}>
                        ...
                        <div className="updateBoxItem">
                            ...
                            <input value={profileCred.email} onChange={onChangeInput} autoComplete="on" className="updateInput" type="email" placeholder="Email" name="email" id="email" />
                        </div>
                        <div className="updateBoxItem">
                            <label htmlFor="desc">Description for ConnectUs profile:</label>
                            <input value={profileCred.desc} onChange={onChangeInput} autoComplete="on" className="updateInput" type="text" placeholder="Description" name="desc" id="desc" />
                        </div>
                        <div className="updateBoxItem">
                            <label htmlFor="city">City:</label>
                            <input value={profileCred.city} onChange={onChangeInput} autoComplete="on" className="updateInput" type="text" placeholder="City" name="city" id="city" />
                        </div>
                        <div className="updateBoxItem">
                            <label htmlFor="from">Country:</label>
                            <input value={profileCred.from} onChange={onChangeInput} autoComplete="on" className="updateInput" type="text" placeholder="Country" name="from" id="from" />
                        </div>
                        <div className="updateBoxItem">
